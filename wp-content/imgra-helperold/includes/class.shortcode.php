<?php
/**
 * Imgra shortcode base class
 *
 *
 * @package  Imgra Helper
 * @author  ThemeBucket <themebucket@gmail.com>
 */

abstract class Imgra_Shortcode {
    ...
    public function __construct() {
        ...
        add_action( 'init', array( $this, 'add_shortcode_map' ) );
    }
    ...
    protected function get_icon( $name, $ext = 'png' ) {
        $dir = trailingslashit( SMARTDEAL_HELPER_URL . 'assets/icons' );
