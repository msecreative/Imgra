...
if ( ! function_exists( 'imgra_setup' ) ) :
	...
	function imgra_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'imgra_custom_background_args', array(
...
function imgra_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Single Widgets', 'imgra' ),
		'id'            => 'single-widget',
		'description'   => esc_html__( 'Add widgets here.', 'imgra' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Contact Widgets', 'imgra' ),
		'id'            => 'contact-widget',
		'description'   => esc_html__( 'Add widgets here.', 'imgra' ),
		'before_widget' => '<div class="sin-footer-icon">',
		'after_widget'  => '</div>',
		'before_title'  => '<div class="footer-icon">',
		'after_title'   => '</div>',
	) );

	register_sidebar( array(
		'name'          => esc_html__( 'Header Left', 'imgra' ),
		'id'            => 'header_left',
		'description'   => esc_html__( 'Add widgets here.', 'imgra' ),
		'before_widget' => '<div class="col-sm-7 col-6 text-left">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	) );
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Header Right', 'imgra' ),
		'id'            => 'header_right',
		'description'   => esc_html__( 'Add widgets here.', 'imgra' ),
		'before_widget' => '<div class="col-sm-5 col-6 text-left text-sm-right">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	) );

	register_widget('header_item');
	//register_widget('header_icon');
 ...
 * Custom Wedget
 */
require get_template_directory() . '/inc/imgra_custom_widget/header_item.php';
require get_template_directory() . '/inc/imgra_custom_widget/subscribe_widget.php';
require get_template_directory() . '/inc/imgra_custom_widget/opening_time_widget.php';
require get_template_directory() . '/inc/imgra_custom_widget/contact_info_widget.php';
//require get_template_directory() . '/inc/imgra_custom_widget/header_icon.php';
